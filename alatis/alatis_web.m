...
function alatis_web(Path_to_input_file, input_type, project3D_flag, addHydrogen_flag, input_website_folder)
clearvars -global
...
global run_test_local run_on_box
...
try
    ...
    % converting other input file formats to sdf
